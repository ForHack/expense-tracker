...
Цель вне `apps/api` (например, файл из `apps/web`) — остановись и скажи: тест-раннера
в `apps/web` сейчас нет, его настройка — отдельная задача, а не часть этого скилла.
